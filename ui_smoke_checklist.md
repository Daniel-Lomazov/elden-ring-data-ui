...
22. Switch the left-sidebar `Layout:` dropdown to `Side by side` and verify the single `Choose Dataset:` control is replaced by `Left pane dataset:`, `Right pane dataset:`, and `Pane height:`.
